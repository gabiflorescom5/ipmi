...
//ipmi 1
//link al video explicativo: https://youtu.be/TpjFOU-dei0 (este es el video de la primera entrega)
// nuevo link del video del recuperatorio: https://youtu.be/R7hDqMi1TLc
//tuve problemas con la camara y no pude grabarme a tiempo ni editarlo
...
//cambiar de color una sola vez


void cambioColorUnaVez(){
  if(key=='g'){
background(colAle);
}
}

color colAle = ColorAleatorio();
